...
import dev.kalmh.basic.controller.dto.ShopDto;
import dev.kalmh.basic.controller.dto.ShopPostDto;
import dev.kalmh.basic.controller.dto.ShopReviewDto;
import dev.kalmh.basic.entity.*;
import dev.kalmh.basic.repository.*;
...
public class ShopService {
    ...
    public List<ShopPostDto> readShopPostAll(Long shopId){
       ...
       this.shopPostRepository.findAll().forEach(shopPostEntity ->
               shopPostDtoList.add(new ShopPostDto(shopPostEntity)));
